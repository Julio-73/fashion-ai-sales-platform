export type Locale = {
  ...
  admin: {
    ...
    dashboard: {
      ...
      title: string;
      description: string;
      metricTotalEmpresas: string;
      metricEmpresasActivas: string;
      metricEmpresasSuspendidas: string;
      metricEmpresasExpiradas: string;
      metricClientesTotales: string;
      metricPedidosTotales: string;
      metricConversacionesTotales: string;
      metricVentasTotales: string;
    ...
    audit: {
      ...
      tableHeaderWhen: string;
      tableHeaderAction: string;
      tableHeaderAdmin: string;
      tableHeaderTarget: string;
      tableHeaderIp: string;
