export type Locale = {
  ...
  crm: {
    ...
    workspace: {
      ...
      allStatuses: string;
      filterVip: string;
      filterRecurrent: string;
      filterVipOnly: string;
      filterRecurrentOnly: string;
      dateFrom: string;
      dateTo: string;
      applyFilters: string;
      clearFilters: string;
      ...
      tableHeaderLifetimeValue: string;
      tableHeaderLastPurchase: string;
      tableHeaderChannel: string;
      emptyTitle: string;
      emptyDesc: string;
      paginationShowing: string;
      ...
      sortFullName: string;
      sortLifetimeValue: string;
      sortLastPurchase: string;
      sortOrderCount: string;
      viewProfile: string;
      fallbackNotSet: string;
    };
    status: {
